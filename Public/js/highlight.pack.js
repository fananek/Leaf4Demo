...
begin:/[-+*/=%^~]|&&?|\|\|?|!=?|<(?:=>?|<|>)?|>[>=]?/,relevance:0}]}}})());hljs.registerLanguage("leaf",(()=>{"use strict";return e=>({name:"Leaf",
...
end:'"'},{className:"variable",begin:"[A-Za-z_][A-Za-z_0-9]*"}]}]}]})})());hljs.registerLanguage("swift",(()=>{"use strict";function e(e){
